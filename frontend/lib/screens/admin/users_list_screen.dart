  ...
  void _filterUsers() {
    ...
    switch (_selectedFilter) {
      ...
      case 'admin':
        ...
        users = _users.where((user) => user.roles.any((role) => role.name == 'admin')).toList();

        break;

      case 'manager':

        users = _users.where((user) => user.roles.any((role) => role.name == 'manager')).toList();

        break;

      case 'trainer':

        users = _users.where((user) => user.roles.any((role) => role.name == 'trainer')).toList();

        break;

      case 'instructor':

        users = _users.where((user) => user.roles.any((role) => role.name == 'instructor')).toList();

        break;

      case 'client':

        users = _users.where((user) => user.roles.any((role) => role.name == 'client')).toList();
    ...
    return Column(
      ...
      children: [
        ...
        _UsersToolbar(
          ...
          onEdit: _selectedUser == null ? null : () {
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                ...
                                leading: CircleAvatar(
                                  backgroundColor: user.roles.isNotEmpty ? _getRoleColor(user.roles.first.name) : Colors.grey,
                                  child: Text(
                                ...
                                trailing: Row(
                                  ...
                                  children: [
                                    ...
                                    if (currentUserIsAdmin && !user.roles.any((role) => role.name == 'client') && !user.roles.any((role) => role.name == 'admin'))
